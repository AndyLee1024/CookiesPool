...
async def main():
    ...
    await page.goto(
        'https://www.xiaohongshu.com/website-login/captcha?redirectPath=http%3A%2F%2Fwww.xiaohongshu.com%2Fdiscovery'
        '%2Fitem%2F628b664800000000010263f5')
...
async def slide(pageObject, captchaObject):
    ...
    for trajectory in trajectories[0]:
        ...
        await page.mouse.move(trajectory[0] + handleX, trajectory[1] + handleY,
                              options={'steps': random.randint(20, 60)})
    await page.mouse.up()
